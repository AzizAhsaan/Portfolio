  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64  lg:pr-0 w-full">
          {/* BIOGRAPHY CONTAINER */}
          <div className="flex flex-col gap-12 justify-center">
            {/* BIOGRAPHY IMAGE */}
            <Image
              src="/AbdulAzizAhsaanPicture.jpg"
              alt=""
              width={112}
              height={112}
            ...
            />
            {/* BIOGRAPHY TITLE */}
            <h1 className="font-bold text-2xl text-white">AbdulAziz Ahsaan</h1>
            {/* BIOGRAPHY DESC */}
